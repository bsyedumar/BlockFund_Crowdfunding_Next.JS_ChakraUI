...
export default function CampaignSingle({
  ...
  async function onSubmit(data) {
    ...
    // Check if the campaign has already reached the target amount
    if (balance >= target) {
      setError("Campaign goal has already been reached.");
      return;
    }
    ...
    try {
      ...
      // Refresh or redirect the page after a successful contribution (optional)
